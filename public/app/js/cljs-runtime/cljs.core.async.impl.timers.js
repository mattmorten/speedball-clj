...
var i_12094 = (self__.level + (1));
while(true){
if((i_12094 <= (new_level + (1)))){
(update[i_12094] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_12111 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12111[i]));
} else {
x__$2.forward.push((((i < links_12111.length))?(links_12111[i]):null));
}

if((i < links_12111.length)){
(links_12111[i] = x__$2);
} else {
links_12111.push(x__$2);
}
...
var i_12115 = (0);
while(true){
if((i_12115 <= self__.level)){
var links_12117 = (update[i_12115]).forward;
if((x__$1 === (((i_12115 < links_12117.length))?(links_12117[i_12115]):null))){
(links_12117[i_12115] = (x__$1.forward[i_12115]));

var G__12118 = (i_12115 + (1));
i_12115 = G__12118;
continue;
} else {
var G__12119 = (i_12115 + (1));
i_12115 = G__12119;
continue;
}
} else {
...
var G__12125 = nx;
var G__12126 = (level__$1 - (1));
x = G__12125;
level__$1 = G__12126;
continue;
} else {
var G__12127 = x;
var G__12128 = (level__$1 - (1));
x = G__12127;
level__$1 = G__12128;
continue;
}
