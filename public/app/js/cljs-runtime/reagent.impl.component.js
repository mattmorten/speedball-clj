...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12011 = c;
var G__12011__$1 = (((G__12011 == null))?null:G__12011.prototype);
if((G__12011__$1 == null)){
return null;
} else {
return G__12011__$1.reagentRender;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__12018 = c;
var G__12018__$1 = (((G__12018 == null))?null:G__12018.constructor);
if((G__12018__$1 == null)){
return null;
} else {
return G__12018__$1.displayName;
}
})();
...
var G__12019 = c;
var G__12019__$1 = (((G__12019 == null))?null:G__12019.constructor);
if((G__12019__$1 == null)){
return null;
} else {
return G__12019__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12022 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12023 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12023);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12022);
}});
...
var c = this;
var G__12060_12120 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12060_12120 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12060_12120);
}
...
var renders_12122 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12123 = cljs.core.first(cljs.core.vals(renders_12122));
...
if((cljs.core.count(renders_12122) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12122))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12123)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12123], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12103 = o;
reagent.impl.component.goog$module$goog$object.set(G__12103,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__12104 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12105 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12105);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12104);
}});
...
var vec__12106 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12106,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12106,(1),null);
...
var G__12109 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12109 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12109);
}
});
}),[]);
