...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k19115,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__19120 = k19115;
var G__19120__$1 = (((G__19120 instanceof cljs.core.Keyword))?G__19120.fqn:null);
switch (G__19120__$1) {
case "error":
return self__.error;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__19125){
var vec__19129 = p__19125;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19129,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19129,(1),null);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__19114){
var self__ = this;
var G__19114__$1 = this;
return (new cljs.core.RecordIter((0),G__19114__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this19116,other19117){
var self__ = this;
var this19116__$1 = this;
return (((!((other19117 == null)))) && ((((this19116__$1.constructor === other19117.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19116__$1.error,other19117.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19116__$1.__extmap,other19117.__extmap)))))));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k19115){
var self__ = this;
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__19114){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__19152 = cljs.core.keyword_identical_QMARK_;
var expr__19153 = k__5309__auto__;
if(cljs.core.truth_((pred__19152.cljs$core$IFn$_invoke$arity$2 ? pred__19152.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__19153) : pred__19152.call(null, new cljs.core.Keyword(null,"error","error",-978969032),expr__19153)))){
return (new clojure.test.check.properties.ErrorResult(G__19114,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__19114),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__19114){
var self__ = this;
var this__5299__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__19114,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__19118){
var extmap__5342__auto__ = (function (){var G__19156 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__19118,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__19118)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__19156);
} else {
return G__19156;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__19118),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
