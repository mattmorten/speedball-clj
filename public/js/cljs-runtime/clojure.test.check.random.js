...
var clojure$test$check$random$IRandom$rand_long$dyn_13582 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_13582(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_13589 = (function (rng){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_13589(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_13596 = (function (rng){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_13596(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_13598 = (function (rng,n){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_13598(rng,n);
}
});
...
var G__13529 = z;
if(((24) > (function (){var G__13531 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__13531) : clojure.test.check.random.longs.bit_count.call(null, G__13531));
})())){
return clojure.test.check.random.longs.bit_xor(G__13529,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__13529;
}
});
...
var G__13603 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__13604 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__13603;
ret = G__13604;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__13551){
var map__13552 = p__13551;
var map__13552__$1 = cljs.core.__destructure_map(map__13552);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13552__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__13553 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13553,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13553,(1),null);
