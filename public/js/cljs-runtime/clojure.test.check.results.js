...
var clojure$test$check$results$Result$pass_QMARK_$dyn_13520 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_13520(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_13523 = (function (result){
var x__5350__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_13523(result);
}
});
