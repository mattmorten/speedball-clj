...
return cljs.core.cons(cljs.core.first(s),(function (){var G__13484 = (n - (1));
var G__13485 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__13484,G__13485) : clojure.test.check.rose_tree.exclude_nth.call(null, G__13484,G__13485));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__13496 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__13496) : f.call(null, G__13496));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13495_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__13495_SHARP_) : clojure.test.check.rose_tree.fmap.call(null, f,p1__13495_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13498_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__13498_SHARP_) : clojure.test.check.rose_tree.filter.call(null, pred,p1__13498_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__13499_SHARP_){
var G__13500 = clojure.test.check.rose_tree.root(p1__13499_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__13500) : pred.call(null, G__13500));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5480__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__13506(s__13507){
return (new cljs.core.LazySeq(null,(function (){
var s__13507__$1 = s__13507;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__13507__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__13513 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13513,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13513,(1),null);
var iterys__5476__auto__ = ((function (s__13507__$1,vec__13513,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__13506_$_iter__13508(s__13509){
return (new cljs.core.LazySeq(null,((function (s__13507__$1,vec__13513,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__13509__$1 = s__13509;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__13509__$1);
if(temp__5804__auto____$1){
var s__13509__$2 = temp__5804__auto____$1;
...
var child = cljs.core._nth(c__5478__auto__,i__13510);
cljs.core.chunk_append(b__13511,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__13605 = (i__13510 + (1));
i__13510 = G__13605;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13511),clojure$test$check$rose_tree$permutations_$_iter__13506_$_iter__13508(cljs.core.chunk_rest(s__13509__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13511),null);
}
} else {
var child = cljs.core.first(s__13509__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__13506_$_iter__13508(cljs.core.rest(s__13509__$2)));
}
} else {
return null;
}
...
});})(s__13507__$1,vec__13513,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__13507__$1,vec__13513,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,clojure$test$check$rose_tree$permutations_$_iter__13506(cljs.core.rest(s__13507__$1)));
} else {
var G__13612 = cljs.core.rest(s__13507__$1);
s__13507__$1 = G__13612;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13532_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__13532_SHARP_) : clojure.test.check.rose_tree.zip.call(null, f,p1__13532_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13533_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__13533_SHARP_) : clojure.test.check.rose_tree.shrink.call(null, f,p1__13533_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__13537 = f;
var G__13538 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__13537,G__13538) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null, G__13537,G__13538));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__13541 = f;
var G__13542 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__13541,G__13542) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null, G__13541,G__13542));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
