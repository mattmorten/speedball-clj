...
var G__11262 = devtools.prefs.pref(v);
v = G__11262;
continue;
} else {
return v;
...
}catch (e11241){var _e__10338__auto__ = e11241;
return false;
}})();
...
}catch (e11243){var _e__10338__auto__ = e11243;
return false;
}})();
...
}catch (e11245){var _e__10338__auto__ = e11245;
return false;
}}
}
});
...
var vec__11256 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11256,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11256,(1),null);
...
return cljs.core.some((function (p1__11259_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11259_SHARP_);
}),template);
});
